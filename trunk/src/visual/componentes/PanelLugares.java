...
public class PanelLugares implements ActionListener{
	...
	public PanelLugares(JFrame unaVentana, GeneradorDePartidas generador, Jugador unJugador, Calendario calendario){
		...
		ImageIcon imagenBotonLugarUno = new ImageIcon("svn/trunk/src/visual/recursos/AlgoThieftBotonLugar"+unJugador.obtenerCiudadActual().obtenerLugares().get(0).obtenerNombre()+"_img.jpg");
		...
		ImageIcon imagenBotonLugarDos = new ImageIcon("svn/trunk/src/visual/recursos/AlgoThieftBotonLugar"+unJugador.obtenerCiudadActual().obtenerLugares().get(1).obtenerNombre()+"_img.jpg");
		...
		ImageIcon imagenBotonLugarTres = new ImageIcon("svn/trunk/src/visual/recursos/AlgoThieftBotonLugar"+unJugador.obtenerCiudadActual().obtenerLugares().get(2).obtenerNombre()+"_img.jpg");
		...
		ImageIcon imagenFondo = new ImageIcon("svn/trunk/src/visual/recursos/AlgoThieftPantallaLugares_img.jpg");
